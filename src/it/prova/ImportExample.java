...
public class ImportExample {
    ...
    public InstanceList readDirectories(File[] directories) {
        ...
        FileIteratorSplitter iterator =
            new FileIteratorSplitter(directories,
                             new TxtFilter(),
                             FileIterator.LAST_DIRECTORY);
    	/*ArrayList<String> a = new ArrayList<String>();
    	a.add("Romans are good because they have pretorians");
    	a.add("Phisic is a scientific matter witch concern the natural function of things");
    	ArrayList<String> b = new ArrayList<String>();
    	b.add("Romani");
    	b.add("Fisica");
    	
        ArrayDataAndTargetIterator iterator = new ArrayDataAndTargetIterator(b,a);*/
    ...
    public static void main (String[] args) throws IOException {
        ...
        double[] topicDistribution = model.getTopicProbabilities(14);
